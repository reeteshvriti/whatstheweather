...
if(isset($_POST['submit'])){
    $city=$_POST['city'];
    $url="http://api.openweathermap.org/data/2.5/weather?q=$city&appid=58c4ff3db2f02811e9beaf705a5ca836";
    $ch=curl_init();
      ...
      <article class="widget">
         ...
         <div class="weatherInfo">
            ...
            <div class="description">
               ...
               <!-- wind speed will be fetched here -->
